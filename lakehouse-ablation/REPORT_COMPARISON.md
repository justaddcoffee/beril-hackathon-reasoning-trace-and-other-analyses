...
| **H2** cassette enriched in REE/mineral environments | soil/sediment OR=**1.92** (p_BH=6×10⁻³⁹), marine 1.31, host-assoc **0.058**, REE-impacted n=37 OR=3.51 (p_BH=0.082, descriptive). **Partially supported.** | **Cannot determine.** Only one-sided anecdotes; no denominators, no controls, no odds ratios. Refused to invent ORs. | **Yes — completely.** This analysis is impossible without the annotation×metadata join over 293K genomes. |
